var linenumbers = require('./linenumber');
...
export var useCodeJar = function useCodeJar(props) {
    ...
    React.useEffect(async function () {
        ...
        var highlight = props.lineNumbers ? withLineNumbers(props.highlight) : props.highlight;
